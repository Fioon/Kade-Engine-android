...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		// Add watermarks
		optionsWatermark = new FlxText(4, "", 16);
		versionWatermark = new FlxText(4, "", 16);
		songWatermark = new FlxText(4,healthBarBG.y + 50,0,SONG.song + " - " + CoolUtil.difficultyFromInt(storyDifficulty) + " | KE 1.5.4", 16);
